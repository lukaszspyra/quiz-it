...
public class AttemptDataProvider {
    ...
    private static Quiz quiz1 = new Quiz(0, "attempt1", 10, MOCKED_DATE_TIME_1, MOCKED_DATE_TIME_1, false, false, List.of(question1));
    private static Quiz quiz2 = new Quiz(1, "attempt2", 12, MOCKED_DATE_TIME_2, MOCKED_DATE_TIME_2, false, false, List.of(question1, question2));
    private static Quiz quiz3 = new Quiz(2, "attempt3", 15, MOCKED_DATE_TIME_1, MOCKED_DATE_TIME_2, false, false, List.of(question1, question2, question3));
